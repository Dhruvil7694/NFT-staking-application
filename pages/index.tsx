    ...
    <div className={styles.container}>
      <div className={styles.heroContainer}>
        <div className={styles.heroContainerData}>
          <h1 className={styles.gradientText3}>ERC721 NFT</h1>
          <p>
            Claim your ERC721 NFT here. You can claim 1 NFT which can be used to
            earn tokens. Earn enough tokens and claim new NFTs.
          </p>
          <p>
            Cost: {ERC721ClaimCondition?.currencyMetadata.displayValue}{" "}
            {ERC721ClaimCondition?.currencyMetadata.symbol}
          </p>
          {address ? (
            <Web3Button
